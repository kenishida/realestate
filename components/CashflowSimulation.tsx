...
/** 円で実数表示（マイナスは ▲ 付き） */
function formatYenWithSign(n: number): string {
  const s = formatYen(Math.round(Math.abs(n)));
  return n < 0 ? `▲ ${s}円` : `${s}円`;
}
              ...
              <table className="min-w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    ...
                    <th className="text-right py-3 px-4 font-semibold text-gray-900">年間収支</th>
                ...
                <tbody className="divide-y divide-gray-100 text-gray-900">
                  <tr>
                    ...
                    <td className="py-2.5 px-4 text-right tabular-nums">{formatYenWithSign(annual.gpi)}</td>
                  ...
                  <tr>
                    ...
                    <td className="py-2.5 px-4 text-right tabular-nums text-red-700">{formatYenWithSign(-annual.vacancyLoss)}</td>
                  ...
                  <tr>
                    ...
                    <td className="py-2.5 px-4 text-right tabular-nums">{formatYenWithSign(annual.egi)}</td>
                    <td className="py-2.5 px-4">実際に入ってくる家賃</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-4 font-medium">OPEX (運営費/諸経費)</td>
                    <td className="py-2.5 px-4 text-right tabular-nums text-red-700">{formatYenWithSign(-annual.opex)}</td>
                  ...
                  <tr>
                    ...
                    <td className="py-2.5 px-4 text-right tabular-nums">{formatYenWithSign(annual.noi)}</td>
                    <td className="py-2.5 px-4">物件が持つ真の収益力</td>
                  </tr>
                  <tr>
                    <td className="py-2.5 px-4 font-medium">ADS (ローン返済額)</td>
                    <td className="py-2.5 px-4 text-right tabular-nums text-red-700">{formatYenWithSign(-annual.ads)}</td>
